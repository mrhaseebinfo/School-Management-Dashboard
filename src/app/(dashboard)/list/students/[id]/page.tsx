      ...
      <div className='w-full xl:w-1/3 flex flex-col gap-4 mx-2'>
        <div className='bg-white p-4 rounded-md'>
          ...
          <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
            ...
            <Link href='/' className='p-2 rounded-md bg-lamaPurpleLight'>Student&apos;s Teacher</Link>
            <Link href='/' className='p-2 rounded-md bg-lamaPurple'>Student&apos;s Exams</Link>
            <Link href='/' className='p-2 rounded-md bg-lamaSkyLight'>Student&apos;s Assignments</Link>
            <Link href='/' className='p-2 rounded-md bg-lamaPurpleLight'>Student&apos;s Results</Link>
          </div>
        </div>
        <PerformanceChart/>
        <Announcements />
