  ...
  const Form = () => {
    return type === 'delete' && id ? (
      <form action="" className="p-4 flex flex-col gap-4">
        ...
        {/* Conditonaly Form Render */}
        <button className="bg-red-700 text-white py-2 px-4 rounded-sm border-none w-max self-center">Delete</button>
